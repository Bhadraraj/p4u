...
const services = [
  {
    image: plumbing1,
    badge: "New Arrival",
    title: "Selvam Plumbing & Electrical Works",
...
export default function TopServicer() {
 ...
 <div className=" mx-auto max-w-[1400px] px-3 sm:px-4 md:px-6 mt-8  ">
        {/* Container with half teal/half white background and rounded corners */}
        <div
          className="rounded-2xl sm:rounded-3xl overflow-hidden"
          style={{
            background:
              "linear-gradient(to bottom, #009999 0%, #009999 70%, white 30%, white 100%)",
          }}
        >
              ...
              {services.map((service, index) => (
                ...
                >
                  ...
                  <div className="p-4 sm:p-5">
                    ...
                    <button
                      className="w-full py-2 sm:py-2.5 rounded-lg text-white text-xs sm:text-sm font-medium transition-colors hover:opacity-90"
