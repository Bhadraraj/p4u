...
// Import product images for first section
...
// Import product images for second section
...
// Import product images for third section
...
export default function PickupSection() {
 ...
 <div className=" mx-auto max-w-[1400px] px-3 sm:px-4 md:px-6 mt-2 sm:mt-3 md:mt-4  ">
      {/* Desktop: 3 columns with large height */}
      <div className="hidden lg:grid lg:grid-cols-3 gap-8">
        {sections.map((section, sectionIndex) => (
          ...
          >
            ...
            {/* <button 
              className="w-full mt-8 py-3 text-base font-semibold rounded-xl transition-colors hover:bg-teal-50"
              style={{ color: 'var(--primary-teal)', border: '2px solid var(--primary-teal)' }}
            >
              Explore More
            </button> */}
          </div>
          ...
          {sections.map((section, sectionIndex) => (
            ...
            >
              ...
              {/* <button 
                ...
                style={{ color: 'var(--primary-teal)', border: '1px solid var(--primary-teal)' }}
              >
                Explore More
              </button> */}
            </div>
